        ...
        <div class="col-sm-12 col-md-8">
            <div class="form-group highlight-addon field-tree-url_value">
                ...
                <div id="menu-value">
                    ...
                    elseif ($node->url_type == 'leader')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\common\models\LeadershipCategory::find()->all(), 'slug', 'name'))->label(false);
